clear;
%list of images
%imglist=importdata('/home/duino/iactive/mtcnn/file_n.txt');
%imglist=importdata('file.txt');
%imglist=importdata('imglist.txt');
imglist=importdata('/home/duino/project/mtcnn/error.txt');
%minimum size of face
minsize=20;

%path of toolbox
caffe_path='/home/duino/project/py-faster-rcnn/caffe-fast-rcnn/matlab';
pdollar_toolbox_path='/home/duino/project/matlab/toolbox'
